...
export default function Footer() {
  return (
    <div className='bg-black py-5 md:py-10 min-h-[28rem] flex flex-col justify-between mt-14 h-full'>
        ...
        <h3 className='text-gray-400 text-center cursor-pointer hover:text-purple-500 hover:underline  text-[0.7rem] lg:text-sm'>© 2024, Iris Engine, Inc. All rights reserved.</h3>
        </div>
