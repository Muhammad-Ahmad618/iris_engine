...
export default function VortexButton({label, click, type, width}) {
  ...
  const baseStyle = 'group flex items-center px-4 gap-x-2 py-1.5 bg-purple-600 rounded-md text-white text-xs lg:text-sm min-[460px]:rounded-lg font-semibold shadow-sm shadow-purple-400 hover:bg-purple-500 lg:px-6 2xl:text-base ';
