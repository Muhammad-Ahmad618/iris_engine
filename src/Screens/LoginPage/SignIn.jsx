    ...
    <div className="min-h-screen bg-custom-gradient ">
      ...
      <nav className="flex justify-center items-center py-7 px-10">
        <div className="text-white flex items-center gap-x-2 hover:text-[#c945ce] ease-in-out duration-150 cursor-pointer">
          <GiBeastEye className="text-[2rem] sm:text-[3rem]" />
          <h3 className="text-[1.4rem] sm:text-[1.7rem] font-medium">Engine</h3>
        </div>
      </nav>
      <div className="flex justify-center items-center mt-7 w-full">
        ...
        <div className="text-white bg-custom-black-80 px-4 mx-3 md:mx-0 md:px-10 py-[1.39rem] rounded-r-lg w-[27rem] h-[33rem] overflow-hidden">
